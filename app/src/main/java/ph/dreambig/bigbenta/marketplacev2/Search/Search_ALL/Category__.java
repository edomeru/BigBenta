...
@Expose
private List<Location___> location = new ArrayList<Location___>();
@SerializedName("year_model")
@Expose
private Object yearModel;
@SerializedName("image")
@Expose
private List<Image___> image = new ArrayList<Image___>();
...
* The location
*/
public List<Location___> getLocation() {
return location;
}
...
* The location
*/
public void setLocation(List<Location___> location) {
...
* The image
*/
public void setImage(List<Image___> image) {
this.image = image;
}
