...
public class Help_CenterFragment extends Fragment {
View x;
 TextView hc_body,hc_body2,hc_body3,hc_Title;
    public Help_CenterFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        x =  inflater.inflate(R.layout.fragment_help__center, container, false);
        hc_body = (TextView)x.findViewById(R.id.hc_body);
        hc_body2= (TextView)x.findViewById(R.id.hc_body2);
        hc_body3= (TextView)x.findViewById(R.id.hc_body3);
        hc_Title= (TextView)x.findViewById(R.id.hc_Title);
