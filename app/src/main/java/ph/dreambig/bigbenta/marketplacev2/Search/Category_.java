...
@Expose
private List<Location__> location = new ArrayList<Location__>();
@SerializedName("year_model")
@Expose
private Object yearModel;
@SerializedName("image")
@Expose
private List<Image__> image = new ArrayList<Image__>();
...
* The location
*/
public List<Location__> getLocation() {
return location;
}
...
* The location
*/
public void setLocation(List<Location__> location) {
...
* The image
*/
public void setImage(List<Image__> image) {
this.image = image;
}
