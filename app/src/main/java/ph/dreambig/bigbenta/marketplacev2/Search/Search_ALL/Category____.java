...
@Expose
private List<Location_____> location = new ArrayList<Location_____>();
@SerializedName("year_model")
@Expose
private Object yearModel;
@SerializedName("image")
@Expose
private List<Image_____> image = new ArrayList<Image_____>();
...
* The location
*/
public List<Location_____> getLocation() {
return location;
}
...
* The location
*/
public void setLocation(List<Location_____> location) {
...
* The image
*/
public List<Image_____> getImage() {
return image;
}
...
* The image
*/
public void setImage(List<Image_____> image) {
this.image = image;
}
